...
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/scroll.js"></script>
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/misc.js"></script>
...
<div id="wrapper">
	<div id="header">
		...
		<div id="bulb"><div id="onBulb" ></div></div>
		 <ul class="navigation">
                <li><a id="about_item" href="#about" rel="1" ></a></li>
